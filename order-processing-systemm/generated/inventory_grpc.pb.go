...
type InventoryServiceClient interface {
	CheckStock(ctx context.Context, in *InventoryRequest, opts ...grpc.CallOption) (*InventoryResponse, error)
}
...
func (c *inventoryServiceClient) CheckStock(ctx context.Context, in *InventoryRequest, opts ...grpc.CallOption) (*InventoryResponse, error) {
...
type InventoryServiceServer interface {
	CheckStock(context.Context, *InventoryRequest) (*InventoryResponse, error)
...
func (UnimplementedInventoryServiceServer) CheckStock(context.Context, *InventoryRequest) (*InventoryResponse, error) {
...
func _InventoryService_CheckStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).CheckStock(ctx, req.(*InventoryRequest))
	}
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "order-processing-system/proto/inventory.proto",
}
